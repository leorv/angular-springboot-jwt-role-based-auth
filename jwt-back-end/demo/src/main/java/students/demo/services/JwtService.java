...
import students.demo.models.JwtRequest;
import students.demo.models.JwtResponse;
import students.demo.models.User;
import students.demo.repositories.UserRepository;
import students.demo.services.util.JwtUtil;
...
public class JwtService implements UserDetailsService {
    ...
    private void authenticate(String userName, String userPassword) throws Exception {
        try {
            ...
            throw new Exception("User is desabled.", e);
